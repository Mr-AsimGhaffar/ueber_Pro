      ...
      <CollapsibleSidebar
        collapseChildren={
          <div>
            ...
            {user?.company?.type === "DRIVERS" && (
              <SidebarLink href={`/${locale}/index/driverTrips`}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
            ...
            {user?.company?.type === "CARS" && (
              <SidebarLink href={`/${locale}/index/carTrips`}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
            ...
            {user?.company?.type === "CARS" && (
              <SidebarLink href={`/${locale}/index/carOffers`}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
            ...
            <SidebarLink href={`/${locale}/index/accounts`}>
              ...
              >
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  d="M3 10l9-7 9 7M4 10h16v10H4V10zM8 21h8"
                />
              </svg>
            </SidebarLink>
      ...
      >
        <div>
          ...
          <SidebarLink href={`/${locale}/index/company`}>
            ...
            <div className="mx-4">Company</div>
          </SidebarLink>
          <SidebarLink href={`/${locale}/index/users`}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          {!(
            user?.company?.type === "DRIVERS" || user?.company?.type === "CARS"
          ) && (
            <SidebarLink href={`/${locale}/index/bookings`}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
